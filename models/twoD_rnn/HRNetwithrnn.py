...
class RNNSeg(nn.Module):
    def __init__(self,config, num_feat=32, num_blocks=30):
    ...
    def forward(self,x):
        ...
        for i in range(t - 1, -1, -1):
            ...
            output = mid_out[:, :, i, :, :]
            feat_prop = self.backward_resblocks(output)
        ...
        for i in range(0, t):
            ...
            feat_prop = self.forward_resblocks(output_curr)
...
class ResidualBlocksWithInputConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=32, num_blocks=30):
        ...
        main.append(nn.Conv2d(in_channels, out_channels, 3, 1, 1, bias=True).cuda())
...
class ResidualBlockNoBN(nn.Module):
    ...
    def __init__(self, mid_channels=32, res_scale=1.0):
        ...
        self.conv1 = nn.Conv2d(mid_channels, mid_channels, 3, 1, 1, bias=True).cuda()
        self.conv2 = nn.Conv2d(mid_channels, mid_channels, 3, 1, 1, bias=True).cuda()
